    ...
    class Example_Admin
    {
        ...
        public function show_notices() {
            ...
            if ($value == ''){
                ...
                <?php echo $channel_id ?>
                    <p><strong><?php echo __( 'Example', 'example' ); ?></strong></p>
                    <p><?php echo __( 'Fill with your Youtube channel ID', 'example' ); ?></p>
                </div>
                <?php
            }
        }
        ...
        public function create_admin_page() {
            ...
            ?>
            <div class="wrap">
                <h1><?php echo __('Example' , 'example'); ?></h1>
        ...
        public function page_init() {   
            ...
            add_settings_section(
                ...
                __('General Settings' , 'example'), // Title
                null, // Callback
        ...
        public function page_footer(){
            return __("Plugin Version") . Example_VERSION;
        }
        ...
        public function channel_id_callback() {
            ...
            <input type="text" id="channel_id" name="my_yt_rec[channel_id]" value="<?php echo $value ?>" class="regular-text" />
                <p class="description"><?php echo __('sample' , 'example') ?>: UCFuIUoyHB12qpYa8Jpxoxow</p>
                <p class="description"><a href="https://support.google.com/youtube/answer/3250431" target="_blank"><?php echo __('Find here your channel Id' , 'example') ?></a></p>
            <?php
        }
        ...
        public function cache_expiration_callback() {
            ...
            ?>
                ...
                <?php echo __('hours is the expiration time for cached data' , 'example') ?>.
                <p class="description"><a href="<?php echo $json_url?>" target="_blank"><?php echo __('Test here' , 'example') ?></a>.
            <?php
        }
        ...
        public function show_position_callback() {
            ...
            ?>
            <fieldset>
                <legend class="screen-reader-text"><span><?php echo __('On posts show videos in position:' , 'example') ?></span></legend>
                <label><input type="radio" name="my_yt_rec[show_position]" value=""<?php echo ( $value == '' ) ? 'checked="checked"' : '' ?>> <?php echo __('Disable' , 'example') ?></label><br>
                <label><input type="radio" name="my_yt_rec[show_position]" value="after"<?php echo ( $value == 'after' ) ? 'checked="checked"' : '' ?>> <?php echo __('After' , 'example') ?></label><br>
                <label><input type="radio" name="my_yt_rec[show_position]" value="before"<?php echo ( $value == 'before' ) ? 'checked="checked"' : '' ?>> <?php echo __('Before' , 'example') ?></label>
            </fieldset>
            <?php
        }
        ...
        public function show_layout_callback() {
            ...
            <select name="my_yt_rec[layout]">
                <option value="grid"<?php echo ( $value == 'grid' ) ? 'selected="selected"' : '' ?>><?php echo __('Grid' , 'example') ?></option>
                <option value="list"<?php echo ( $value == 'list' ) ? 'selected="selected"' : '' ?>><?php echo __('List' , 'example') ?></option>
            </select>
            <?php
        }
        ...
        public function limit_callback() {
            ...
            <p class="description"><?php echo __('Max' , 'example') ?> 15</p>
            <?php
        }
